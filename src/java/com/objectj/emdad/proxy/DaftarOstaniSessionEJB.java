 ...
 * @ejb.bean
 *    type="Stateless"
 *    name="DaftarOstaniSession"
 *    jndi-name="ejb/emdad/DaftarOstaniSession"
 *    local-jndi-name="ejb/emdad/DaftarOstaniSessionLocal"
 *    view-type="both"
 *    cmp-version="2.x"
...
public abstract class DaftarOstaniSessionEJB extends ProxySessionEJB implements javax.ejb.SessionBean, EntityProxy {
