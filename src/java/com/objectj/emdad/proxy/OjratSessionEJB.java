 ...
 *    type="Stateless"
 *    name="OjratSession"
 *    jndi-name="ejb/emdad/OjratSession"
 *    local-jndi-name="ejb/emdad/OjratSessionLocal"
 *    view-type="both"
 *    cmp-version="2.x"
...
public abstract class OjratSessionEJB extends ProxySessionEJB implements javax.ejb.SessionBean, EntityProxy {
	...
	public ValueObject resultSetToBean(ResultSet resultSet) {
		try {
			...
			ojratModel.setId(resultSet.getString("id"));
			ojratModel.setOjratId(resultSet.getString("ojratId"));
			ojratModel.setOjrat(new Integer(resultSet.getString("ojrat")));
			ojratModel.setOnvan(resultSet.getString("onvan"));
			return ojratModel;
		} catch (Exception e) {
			e.printStackTrace();
		}
