 ...
 * @ejb.bean
 *    type="Stateless"
 *    name="NoeEmdadgarSession"
 *    jndi-name="ejb/emdad/NoeEmdadgarSession"
 *    local-jndi-name="ejb/emdad/NoeEmdadgarSessionLocal"
 *    view-type="both"
 *    cmp-version="2.x"
...
public abstract class NoeEmdadgarSessionEJB extends ProxySessionEJB implements javax.ejb.SessionBean, EntityProxy {
