 ...
 * @ejb.bean
 *    type="Stateless"
 *    name="DalileToolKeshidaneEmdadSession"
 *    jndi-name="ejb/emdad/DalileToolKeshidaneEmdadSession"
 *    local-jndi-name="ejb/emdad/DalileToolKeshidaneEmdadSessionLocal"
 *    view-type="both"
 *    cmp-version="2.x"
...
public abstract class DalileToolKeshidaneEmdadSessionEJB extends ProxySessionEJB implements javax.ejb.SessionBean, EntityProxy {
