 ...
 * @ejb.bean
 *    type="Stateless"
 *    name="KhodrosazSession"
 *    jndi-name="ejb/emdad/KhodrosazSession"
 *    local-jndi-name="ejb/emdad/KhodrosazSessionLocal"
 *    view-type="both"
 *    cmp-version="2.x"
...
public abstract class KhodrosazSessionEJB extends ProxySessionEJB implements javax.ejb.SessionBean, EntityProxy {
