...
<html:form method="post" action="/l/noeBazaryab">
    <!------------------------------------------------>
...
<table width="100%" dir="rtl" align="center" class="generalText" border="0" cellpadding="3" cellspacing="0">
		<tr>
			...
			<td class="filterFieldCell"><html:text onkeypress="doFilterByEnter();" property="noeBazaryabId" size="3" maxlength="5" styleClass="field"/></td>
        ...
        <tr class="listTableHeader">
            <jsp:include page="/com/objectj/resources/jsp/tiles/emdad/checkAll.jsp" flush="true" />
						...
						<td class = "listRow0Col">
							<jsp:setProperty name="cur_records" property="columnName" value= "noeBazaryabId"
							/><jsp:setProperty name="cur_records" property="columnTitle" value= "شناسه نوع بازاریاب"
						...
						<td class = "listRow0Col">
							...
							/><jsp:setProperty name="cur_records" property="columnTitle" value= "جدول مرجع"
							/><jsp:getProperty name="cur_records" property="sortableColumnString" />
						</td>
					</tr>
					...
					<logic:iterate id="value_object" name="value_object_list" >
						<tr  class="listRow<%=i%2%>">
							...
							<td class = "listRow1Col">
                                ...
                                <bean:write property="noeBazaryabId" name="value_object"/>
                                <logic:equal name="entity_access" property="readAccess" value="true" >
                                	</a>
                                </logic:equal>
                            </td>
							...
							<td class = "listRow1Col"><bean:write property="entityName" name="value_object"/></td>
						</tr>
						<%i++;%>
					</logic:iterate>
