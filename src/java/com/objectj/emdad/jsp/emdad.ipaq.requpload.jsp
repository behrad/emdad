...
<script language="JavaScript">
	function chkFileName() {
		var path = document.emdadIpaqReqUpload.file.value;		
		if ( path == "" ) {
...
<form name="emdadIpaqReqUpload"  method="post" action="/emdad/com/objectj/emdad/jsp/emdad.ipaq.doupload.jsp" enctype="multipart/form-data" onSubmit="return chkFileName();">
