...
<head>
<html:base/>
<TITLE>معرفي فايل نمايندگي</TITLE>
...
<form name="serviceReqUpload"  method="post" action="/emdad/com/objectj/emdad/jsp/serviceDorei.doupload.jsp" enctype="multipart/form-data" onSubmit="return chkFileName();">
			...
			<td align="center">
                ...
                <%= ( message == null ) ? "" : message %>
					...
					<tr class="editRow0">
						...
						<td><INPUT dir="ltr" TYPE="FILE" NAME="file" size="60" class="field"/></td>
					</tr>
