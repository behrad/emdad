...
<html:form method="post" action="/l/dalileToolKeshidaneEmdad">
	...
	<table width="100%" dir="rtl" align="center" class="generalText" border="0" cellpadding="3" cellspacing="0">
		...
		<tr>
			...
			<td class="filterFieldCell"><html:text onkeypress="doFilterByEnter();" property="dalileToolKeshidaneEmdadId" size="3" maxlength="5" styleClass="field"/></td>
		...
		<tr class="listTableHeader">
			...
			<td class = "listRow0Col">
            	<jsp:setProperty name="cur_records" property="columnName" value= "dalileToolKeshidaneEmdadId"
		...
		<logic:iterate id="value_object" name="value_object_list" >
			<tr class="listRow<%=i%2%>">
				...
				<td class = "listRow1Col">
					...
					<bean:write property="dalileToolKeshidaneEmdadId" name="value_object"/>
					<logic:equal name="entity_access" property="readAccess" value="true" >
						</a >
					</logic:equal>
				</td>
