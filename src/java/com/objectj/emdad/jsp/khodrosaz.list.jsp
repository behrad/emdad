...
<html:form method="post" action="/l/khodrosaz">
...
<table width="100%" dir="rtl" align="center" class="generalText" border="0" cellpadding="3" cellspacing="0">
		...
		<tr>
			...
			<td class="filterFieldCell"><html:text onkeypress="doFilterByEnter();" property="khodrosazId" size="3" maxlength="5" styleClass="field"/></td>
			<td class="filterFieldCell"><html:text property="name" size="20" maxlength="30" onkeypress="return ( submitenter2(this,event) && doFilterByEnter() );" styleClass="field"/></td>
        </tr>
		...
		<tr class="listTableHeader">
            ...
            <td class = "listRow0Col">
                <jsp:setProperty name="cur_records" property="columnName" value= "khodrosazId"
                /><jsp:setProperty name="cur_records" property="columnTitle" value= "شناسه خودروساز"
            ...
            <td class = "listRow0Col">
                ...
                /><jsp:setProperty name="cur_records" property="columnTitle" value= "نام خودروساز"
                /><jsp:getProperty name="cur_records" property="sortableColumnString" />
            </td>
        </tr>
        ...
        <logic:iterate id="value_object" name="value_object_list" >
            <tr  class="listRow<%=i%2%>">
				...
				<td class = "listRow1Col">
					...
					<bean:write property="khodrosazId" name="value_object"/>
					<logic:equal name="entity_access" property="readAccess" value="true" >
						</a>
					</logic:equal>
                </td>
