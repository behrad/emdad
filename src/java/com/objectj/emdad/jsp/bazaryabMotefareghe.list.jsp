...
<html:form method="post" action="/r/bazaryabMotefareghe">
	...
	<table width="100%" dir="rtl" align="center" class="generalText" border="0" cellpadding="3" cellspacing="0">
		...
		<tr>
			...
			<td class="filterFieldCell"><html:text property="tel" size="15" maxlength="50" onkeypress="return ( submitenter2(this,event) && doFilterByEnter() );" styleClass="field"/></td>
			<td class="filterFieldCell"><html:text property="mobile" size="15" maxlength="50" onkeypress="return ( submitenter2(this,event) && doFilterByEnter() );" styleClass="field"/></td>
		...
		<tr class="listTableHeader">
			...
			<td class = "listRow0Col">
				...
				/><jsp:setProperty name="cur_records" property="columnTitle" value= "موبايل"
				/><jsp:getProperty name="cur_records" property="sortableColumnString" />
			</td>
		...
		<logic:iterate id="value_object" name="value_object_list" >
			<tr class="listRow<%=i%2%>">
				...
				<td class = "listRow1Col">
					...
					<bean:write property="name" name="value_object"/>
					<logic:equal name="entity_access" property="readAccess" value="true" >
						</a >
					</logic:equal>
				</td>
