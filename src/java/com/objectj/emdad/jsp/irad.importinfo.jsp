...
<html:form method="post" action="/l/irad">
	<table dir=rtl align="center" class="generalText">
		...
		<tr class="listTableHeader">
			<td class = "listRow0Col" width="%5">رديف</td>33
		...
		<tr  class="listTableHeader"><td colspan="5" class = "listRow0Col"><a href="/logs/importIrad.html"><span class="textW"> نمايش فايل Log </span></a></td></tr>
		</logic:greaterEqual>
