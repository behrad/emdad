...
<html:base/>
<html:form method="post" action="/r/noeBazaryab">
		...
		<tr>
			<td align="center"> 
				<table border="0" cellpadding="4" cellspacing="0" class="readTable">
					...
					<tr class="readRow0"> 
						<td class="readLabel">شناسه نوع بازاریاب:</td>
						<td width="5%"></td>
						<td class="readData"><bean:write property="noeBazaryabId" name="value_object"/></td>
					</tr>
					...
					<tr class="readRow0">
						<td class="readLabel">جدول مرجع:</td>
						<td width="5%"></td>
