...
<table width="100%" dir="rtl" align="center" class="generalText" border="0" cellpadding="3" cellspacing="0">
		<% int i = 0; %>
		<logic:iterate id="ss" name="naghsheList" >
			<tr class="listRow<%=i%2%>">

				<td class = "listRow1Col">
                    &nbsp;<bean:write property="ostanName" name="ss"/>&nbsp;
				</td>
				<td class = "listRow1Col">
                    <bean:write property="shahrName" name="ss"/>
				</td>
				<td class = "listRow1Col">
                    <bean:write property="namayandegiName" name="ss"/>
				</td>
				<td class = "listRow1Col">
                    <bean:write property="emdadgarName" name="ss"/>
				</td>
            </tr>
