...
<html:form method="post" action="/r/moshtarak">
	...
	<table width="100%" align="center"  border="0" cellpadding="4" cellspacing="0" dir=rtl class="generalText">
		...
		<tr class="readRow0">
			...
			<!--<td width="5%"></td>-->
			<td class="readData"><bean:write name="tarikhTahvil" />
		...
		<tr class="readRow1">
			...
			<!--<td width="5%"></td>-->
			<td class="readData"><bean:write property="vazeatName" name="value_object"/></td>
		...
		<tr class="readRow0">
			...
			<!--<td width="5%"></td>-->
			<td colSpan="3" class="readData"><bean:write name="tarikhAkharinTamdid"/></td>
		</tr>
		...
		<tr class="readRow1">
			...
			<!--<td width="5%"></td>-->
			<td colSpan="3" class="readData"><bean:write property="mahaleServiceAvalieh" name="value_object"/></td>
		</tr>
	</table>
</html:form>
