...
<html:form method="post" action="/l/darkhastQate">
	...
	<table width="100%" dir="rtl" align="center" class="generalText" border="0" cellpadding="3" cellspacing="0">
		...
		<tr>
			...
			<td class="filterFieldCell"><html:text onkeypress="doFilterByEnter();" property="darkhastQateId" size="3" maxlength="5" styleClass="field"/></td>
			...
			<td class="filterFieldCell"><html:text onkeypress="doFilterByEnter();" property="tarikhDarkhast" size="7" maxlength="10" styleClass="field"/></td>
			<td class="filterFieldCell"><html:text property="qateName" size="3" maxlength="5" styleClass="field" onkeypress="return ( submitenter2(this,event) && doFilterByEnter() );"/></td>
			<td class="filterFieldCell"><html:text onkeypress="doFilterByEnter();" property="tedadDarkhasti" size="3" maxlength="5" styleClass="field"/></td>
		</tr>
		...
		<tr class="listTableHeader">
			...
			<td class = "listRow0Col">
				<jsp:setProperty name="cur_records" property="columnName" value= "darkhastQateId"
			...
			<td class = "listRow0Col">
				<jsp:setProperty name="cur_records" property="columnName" value= "tarikhDarkhast"
				/><jsp:setProperty name="cur_records" property="columnTitle" value= "تاریخ درخواست"
				/><jsp:getProperty name="cur_records" property="sortableColumnString" />
			</td>
			...
			<td class = "listRow0Col">
				<jsp:setProperty name="cur_records" property="columnName" value= "tedadDarkhasti"
				/><jsp:setProperty name="cur_records" property="columnTitle" value= "تعداد درخواستی"
				/><jsp:getProperty name="cur_records" property="sortableColumnString" />
			</td>
		</tr>
		...
		<logic:iterate id="value_object" name="value_object_list" >
			<tr class="listRow<%=i%2%>">
                ...
                <td class = "listRow1Col" align="center">
                    <logic:equal name="entity_access" property="updateAccess" value="true" >
                        ...
                        <logic:notEqual name="role" value="anbar" >
                            <logic:notEqual name="value_object" property="taeedShodehSarparast" value="1">
                        ...
                        <logic:equal name="role" value="anbar" >
                            <logic:notEqual name="value_object" property="taeedShodeAnbar" value="1">
                                    <a  href='javascript:edit("<bean:write name="value_object" property="id"  />");'><img src="images/pencil.gif" border="0"></a >
                            </logic:notEqual>
                        </logic:equal>
                    </logic:equal>
                ...
                <td class = "listRow1Col">
                    ...
                    <bean:write property="darkhastQateId" name="value_object"/>
                    <logic:equal name="entity_access" property="readAccess" value="true" >
                        </a>
                    </logic:equal>
                </td>
				...
				<td class = "listRow1Col"><bean:write property="tarikhDarkhastHejri" name="value_object"/></td>

				<td class = "listRow1Col"><bean:write property="qateName" name="value_object"/></td>

				<td class = "listRow1Col"><bean:write property="tedadDarkhasti" name="value_object"/></td>
            </tr>
            <%i++;%>
        </logic:iterate>
    </table>
