...
<html:base/>
<logic:equal name="qateForm" property="sorttype" value="succeed" >
<script>
function doing() {
	...
	document.qateForm.takmilBtn.disabled = true;
...
<table border="0">
  ...
  <tr> 
	...
	<html:form method="post" action="/s/qate" onsubmit="return doing();">
...
<logic:equal name="qateForm" property="sorttype" value="failed" >
<div align="center" class="error">
	<p>انتقال فايل به سرور با مشکل مواجه شد.</p><br>
	<p><a href="/emdad/l/qate.run"> بازگشت </a></p>
</div>
</logic:equal>
