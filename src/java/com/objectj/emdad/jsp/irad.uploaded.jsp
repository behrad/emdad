...
<html:base/>
<logic:equal name="iradForm" property="sorttype" value="succeed" >
<script>
function doing() {
	...
	document.iradForm.takmilBtn.disabled = true;
...
<table border="0">
  ...
  <tr id="isDoing2" style="display:inline;" >
    <td>&nbsp;</td>
    <td> انتقال فهرست ايرادها به پايگاه داده ها</td>
  </tr>
</table>
...
<table border="0">
  ...
  <tr>
	...
	<html:form method="post" action="/s/irad" onsubmit="return doing();">
	<html:hidden property="action_type" value="specific,doimport"/>
	<html:hidden property="id"/>
    <input type="hidden" name="farsi" value="<bean:write name="farsi" />" />
	<input type="submit" name="takmilBtn" value=" تکميل انتقال اطلاعات ايرادها " />
	</html:form>
</div>
</logic:equal>
<logic:equal name="iradForm" property="sorttype" value="failed" >
<div align="center" class="error">
	<p>انتقال فايل به سرور با مشکل مواجه شد.</p><br>
	<p><a href="/emdad/l/irad.run"> بازگشت </a></p>
</div>
</logic:equal>
