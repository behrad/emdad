	...
	<tr>
		<td align="center">
			<table border="0" cellpadding="2" cellspacing="0" class="editTable">
				<!----------------------------------------->
				<tr class="editRow0">
					<td class="editLabel" colspan="3">&nbsp;</td>
				</tr>
				<!----------------------------------------->
				<tr class="editRow0">
...
<br>
<center>
<input type="button" value=" انصراف " class="emdadButton" onClick="top.close();"/>&nbsp;&nbsp;
</center>
</html:form>
</body>
<!----------------------------------------->
...
function extNoeEmdadgar(){
	document.kasriEmdadForm.disabled=true;
	document.kasriEmdadForm.action = "/emdad/s/kasriEmdad.run?action_type=specific,kasriNoeEmdadgar";
	document.kasriEmdadForm.submit();
}
function extEmdadgar(){
	document.kasriEmdadForm.disabled=true;
	document.kasriEmdadForm.action = "/emdad/s/kasriEmdad.run?action_type=specific,kasriEmdadgar";
	document.kasriEmdadForm.submit();
}
</script>
