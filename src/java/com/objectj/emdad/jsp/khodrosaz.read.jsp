...
<html:base/>
<html:form method="post" action="/r/khodrosaz">
		...
		<tr>
			<td align="center"> 
				<table border="0" cellpadding="4" cellspacing="0" class="readTable">
					...
					<tr class="readRow0"> 
						<td class="readLabel">شناسه خودروساز:</td>
						<td width="5%"></td>
						<td class="readData"><bean:write property="khodrosazId" name="value_object"/></td>
					</tr>
						
					<!---------------------------------------->
	
					<tr class="readRow1"> 
						<td class="readLabel">نام خودروساز:</td>
						<td width="5%"></td>
