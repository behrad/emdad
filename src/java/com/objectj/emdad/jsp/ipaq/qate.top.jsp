...
<body>
<div align="center"><h4>فهرست قطعه هاي موجود</h4></div>
...
<table class="generalText" id="grid" bordercolor="#999999" border="1" align="center" cellspacing="0" cellpadding="10">
  ...
  <tr class="listTableHeader" id="header">
    ...
    <td class="editLabel" align="center" id="col1"><a href="javascript:sortById();"><font color="#FFFFFF">شماره 
      فني</font></a></td>
    <td class="editLabel" align="center" id="col2"><a href="javascript:sortByName();"><font color="#FFFFFF">نام</font></a></td>
    <td class="editLabel" align="center" id="col3"><font color="#FFFFFF">قيمت</font></td>
  </tr>
