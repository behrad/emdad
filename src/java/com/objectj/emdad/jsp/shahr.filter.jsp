...
<!----------------------------------------->
				...
				<td class="filterCol"> 
					<select  class="generalText" id="field">
						<option  value="shahr.shahrId" id="Integer">شناسه شهر</option >
						<option  value="shahr.shahrName" id="String">نام شهر</option >
						<option  value="shahr.codeShahrKhodrosaz" id="String">کد شهر خودروساز</option >
					</select > 
				</td>
