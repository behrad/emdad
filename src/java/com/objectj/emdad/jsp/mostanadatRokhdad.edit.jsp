...
<script>
	...
	function rokhdadSearch() {
		s="1";
		doSearchAndHide("showRokhdad", 
				 "/emdad/com/objectj/emdad/jsp/general.findf.jsp?url=/emdad/s/rokhdad.run?action_type=specific,find%26eghdam="+s, 
				 document.mostanadatRokhdadForm,
				 "dimg1");
	}
...
<body onkeydown="Sabt()"/>
<html:form   method="post" action="/c/validatemostanadatRokhdad" onsubmit="return validateMostanadatRokhdadForm(this)">
			...
			<td align="center">
				<table border="0" cellpadding="2" cellspacing="0" class="editTable">
					...
					<tr class="editRow1">
						...
						<td class="editStar">*</td>
                        <td>
							<html:text property="rokhdadRokhdadId" size="20" maxlength="20" styleClass="field" onchange="valueChanged(this)"/>
							...
							<logic:equal name="mostanadatRokhdadForm" property="action_type" value="create">
								&nbsp;
								<input type="button" value="جستجو" onClick="javascript:rokhdadSearch();" />	
							</logic:equal>  
						</td>
					</tr>
...
<script type="text/javascript" language="Javascript1.1">
	...
	{
        document.mostanadatRokhdadForm.action="/emdad/c/validatemostanadatRokhdad.run";
    }

	else
	{
        document.mostanadatRokhdadForm.action="/emdad/u/validatemostanadatRokhdad.run";
    }
