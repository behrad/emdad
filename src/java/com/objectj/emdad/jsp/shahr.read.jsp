...
<html:base/>
<html:form method="post" action="/r/shahr">
		...
		<tr>
			<td align="center">
				<table border="0" cellpadding="4" cellspacing="0" class="readTable">
					...
					<tr class="readRow0">
						<td class="readLabel">شناسه شهر:</td>
						<td width="5%"></td>
						<td class="readData"><bean:write property="shahrId" name="value_object"/></td>
					</tr>
					...
					<tr class="readRow0">
						...
						<td width="5%"></td>
						<td class="readData"><bean:write property="ostanName" name="value_object"/></td>
					</tr>

					<!---------------------------------------->

					<tr class="readRow1">
						<td class="readLabel">کد شهر خودروساز:</td>
						<td width="5%"></td>
						<td class="readData"><bean:write property="codeShahrKhodrosaz" name="value_object"/></td>
					</tr>
