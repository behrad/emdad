...
<BODY dir="rtl">
<h2 align="center">دریافت فایل اکسل نمایندگی</h2>
...
<jsp:include page="/com/objectj/resources/jsp/tiles/emdad/help.jsp" flush="true">
   <jsp:param name="help_url" value="import.xls.html" />	
</jsp:include>
  </tr>
  <tr> 
</table>

<form name="emdadReqUpload"  method="post" action="/emdad/com/objectj/emdad/jsp/emdad.doupload.jsp" enctype="multipart/form-data" onSubmit="return chkFileName();">
