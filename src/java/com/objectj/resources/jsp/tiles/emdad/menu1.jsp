...
function sivij(idx) {
	...
	if (idx<7) {  //(idx == 1) || (idx == 2) || (idx == 3) || (idx == 4) || (idx == 5) || (idx == 6)){
		closeAll = true;
	}
...
<%
	boolean showMenu = SysAdminDAO.hasMenuOfKind(menus, "todo"); // false;
...
<%
	//showMenu = !SysAdminDAO.hasMenuOfKind(menus, "base") &&  !SysAdminDAO.hasMenuOfKind(menus, "report") && !SysAdminDAO.hasMenuOfKind(menus, "reportp") && !SysAdminDAO.hasMenuOfKind(menus, "todo"); //false;
...
<%
	showMenu = SysAdminDAO.hasMenuOfKind(menus, "base"); //false;
    /*for (Iterator menuIt = menus.iterator(); menuIt.hasNext();) {
        MenuModel mm = (MenuModel) menuIt.next();
...
<%
	showMenu = SysAdminDAO.hasMenuOfKind(menus, "report") || SysAdminDAO.hasMenuOfKind(menus, "reportp"); //false;
	System.out.println("00="+showMenu);
/*    for (Iterator menuIt = menus.iterator(); menuIt.hasNext();) {
        MenuModel mm = (MenuModel) menuIt.next();
...
%>
	...
	<% if (SysAdminDAO.hasMenuOfKind(menus, "report")) { %>
	...
	<%// if (SysAdminDAO.hasMenuOfKind(menus, "reportp")) { %>

					<tr><td id="td7"  background="images/menu-top-strip.jpg" align="center">
...
<%
	showMenu = SysAdminDAO.hasMenuOfKind(menus, "savabegh") ; // false;
    /*for (Iterator menuIt = menus.iterator(); menuIt.hasNext();) {
        MenuModel mm = (MenuModel) menuIt.next();
...
<%
	showMenu = SysAdminDAO.hasMenuOfKind(menus, "search") ; // false;
    /*for (Iterator menuIt = menus.iterator(); menuIt.hasNext();) {
        MenuModel mm = (MenuModel) menuIt.next();
